...
return (
  ...
  <section class="sub_wrap">
    <article class="s_cnt mp_pro_li ct1">
      <div class="li_top"><h2 class="s_tit1">Management</h2></div>
    ...
    <article class="res_w">
        <label for="is_Swt_toolname" style={{ fontSize:20}}><b>툴 이름 :</b></label>
        <input type="text" name="is_Swt_toolname" id="is_Swt_toolname" class="" style={{border:"none", fontSize:80, marginLeft:100}} readOnly/>
      <div class="tb_outline">
        ...
        <tr>
          ...
          <td className="fileBox fileBox1">
            ...
            readOnly="readonly" placeholder="선택된 파일 없음" style={{border:"none"}}/>
          </td>
        </tr>
        <tr>
          <th>라벨 이미지</th>
          ...
          <tr>
            <th><label for="is_Swt_demo_site">데모 URL<span class="red" ></span></label></th>
            <td><input type="text" name="is_Swt_demo_site" id="is_Swt_demo_site" class="" style={{border:"none"}} readOnly/></td>
          </tr>
          <tr>
            <th><label for="is_Giturl">Github URL<span class="red"></span></label></th>
            <td><input type="text" name="is_Giturl" id="is_Giturl" class="" style={{border:"none"}} readOnly/></td>
          </tr>
        <tr class="div_tb_tr fileb">
          ...
          <tr>
            <th><label for="is_Comments">설명<span class="red"></span></label></th>
            <td><textarea name="is_Comments" id="is_Comments" rows="" cols="" readOnly></textarea></td>
          </tr>
          <tr>
            <th><label for="is_Swt_function">상세 기능<span class="red"></span></label></th>
            <td><textarea name="is_Swt_function" id="is_Swt_function" rows="" cols="" readOnly></textarea></td>
          </tr>
        </table>  
        </div>
        </article>
        ...
        <botton class="btn btn-dark"><Link to={'/SoftwareList/'} style={{color:"#fff", textDecoration:"none", fontSize:30}}>목록</Link></botton>
        </div>
      </div> 
    </article>
  </section>
